...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <a href="index.html"><img src="assets/img/Logo SAAU Umuarama.png" alt="" class="img-fluid"></a>
            </div>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="active" href="blog.html">NOTÍCIAS</a></li>
                    <li><a href="#">LOJA</a></li>
