                ...
                <div class="row ">
                            ...
                            <div class="card card-profile">
                                <div class="card-avatar">
                                    <div class="text-center pb-3">
                                        <img id="preview-image" class="rounded-circle mt-4" width="170px"
                                ...
                                <div class="card-content pl-3  pr-2">
                                    ...
                                    <hr>
                                    <div style="overflow:auto; height: 189px;" class=" card-content pl-3 pr-2">
                                        <?php
                                        echo "{$perfil->sobremim}";
                                     ?>
                                    </div>
                                    @else
                    ...
                    <div class="col-lg-8 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="email" disabled="" class="form-control border-input"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control border-input"
                                                value="{{ isset($user) ? $user->permissao : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control border-input"
                                                value="{{ isset($perfil) ? $perfil->logradouro: '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control border-input"
                                                value="{{ isset($perfil) ? $perfil->profissao : '' }}">
                                        </div>
                        ...
                        <div style="width:100px;margin-top: 10px; right: 10px; position: absolute;">
                            <a class="btn btn-block bg-gradient-primary"
                                href="{{route('mostrar_funcionario')}}">Voltar</a>
                        </div>
                    </div>
                </div>
            </div>
